const ActionButton = () => {
  return (
    <div className="relative flex items-center justify-between w-full">
      ...
      <span className="absolute z-50 -translate-x-1/2 left-1/2">
        <div className="relative flex flex-col items-center w-fit gap-2 select-none h-fit text-text-primary transition-all ease-in-out duration-500 opacity-100">
                          ...
                          <span className="h-[40px] rounded-full flex justify-center border-[5px] w-[40px] items-center">
                            ...
                            >
                              ...
                              <span
                                ...
                                style={{
                                  borderLeft: "2px solid rgb(217, 70, 239)",
                                  borderRight: "2pxsolid rgb(217, 70, 239)",
                                }}
                              />
      ...
      <span className="flex gap-2">
        <div className="flex items-center gap-1 p-2 text-xs font-semibold text-white border rounded-full cursor-pointer border-white/20 glass">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
