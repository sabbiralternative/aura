...
const Search = ({ setShowSearch }) => {
  ...
  return (
    <div className="flex items-center justify-between w-full gap-2 py-4 px-3 md:px-0transition-all ease-in-out duration-300 origin-top-right relative popUpOpenAnimation  ">
      <input
        autoFocus
        value={searchText}
      ...
      <button
        ...
        className="pl-4 flex items-center justify-center  absolute top-1/2 right-4  -translate-y-1/2"
