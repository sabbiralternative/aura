            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  className={`flex background-style flex-col relative items-center gap-1 justify-center p-1 border-2 cursor-pointer rounded-l-lg ${runner?.status === Status.WINNER ? "border-yellow-400" : "border-white/10"}`}
                  style={{
                ...
                <div
                  ...
                  className={`flex background-style flex-col relative items-center gap-1 justify-center p-1 border-2 cursor-pointer rounded-r-lg ${runner?.status === Status.WINNER ? "border-yellow-400" : "border-white/10"} `}
                  style={{
            ...
            game?.runners?.map((runner) => {
              ...
              return (
                <div
                  ...
                  key={runner?.id}
                  className={`relative background-style-3 flex items-center justify-center p-3 border-2 rounded-lg cursor-pointer ${runner?.status === Status.WINNER ? "border-yellow-400" : "border-white/10"}`}
                  style={{
