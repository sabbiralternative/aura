        ...
        <div style={{ width: "100%", height: "100%", position: "relative" }}>
          ...
          >
            ...
            >
              ...
              >
                <div className="transition-transform duration-300 z-50 flex items-end gap-1 ">
                  <div className="flex flex-col bg-gradient-to-t to-transparent items-center overflow-hidden rounded from-[#4338ca]">
                    ...
                    <div className="flex items-center justify-center px-0.5 w-full text-white bg-white/10">
                      <span className="text-[0.6rem] whitespace-nowrap font-medium lg:text-sm">
                        Player A
                      </span>
                    </div>
                  </div>
                  <div className="flex flex-col bg-gradient-to-t to-transparent items-center overflow-hidden rounded from-white/5">
                    <div className="flex gap-1 items-center p-1">
                      <div className>
                        <div
                          className="relative  "
                  ...
                  <div className="flex flex-col bg-gradient-to-t to-transparent items-center overflow-hidden rounded from-[#6d28d9]">
                    <div className="flex gap-1 items-center p-1">
                      <div className>
                        <div
                          className="relative  "
